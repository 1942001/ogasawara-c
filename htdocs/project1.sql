...
--
-- テーブルのデータのダンプ `project1`
--

INSERT INTO `project1` (`userid`, `itemid`, `contents`, `カテゴリ`, `期日`, `チェック`) VALUES
